...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        challenge1.setName("Mindful Hand Awareness");
        challenge1.setLevel("5 minute challenge");
        challenge1.setDescription("1: Clench your fists 5 seconds, then release and notice how your hands feel. 2: Try to attend to this feeling for as long as possible. 3: Continue with the same technique, clenching, and if you feel like you want to do it for longer, you can.");
        challenge1.setValue(10);
        challengeInformationRepository.save(challenge1);
        Challenge challenge2 = new Challenge();
        challenge2.setName("Music Appreciation");
        challenge2.setLevel("5 minute challenge");
        challenge2.setDescription("1: Put on one of your favourite songs. 2: Pay attention to how this music makes you feel. 3: Ask yourself: What emotions am I experiencing? 4: What memories come up? How do they make you feel?");
        challenge2.setValue(10);
        challengeInformationRepository.save(challenge2);
        Challenge challenge3 = new Challenge();
        challenge3.setName("Smiling Jumping Jacks");
        challenge3.setLevel("5 minute challenge");
        challenge3.setDescription("1: Breate in and breathe out. 2: Execute 5 jumping jacks. Every time you start a new jumping jack, widen your smile. 3: After doing five jumping jacks your smile should be the biggest it can possibly can. 4: Repeat until you feel is necessary.");
        challenge3.setValue(10);
        challengeInformationRepository.save(challenge3);
        Challenge challenge4 = new Challenge();
        challenge4.setName("Deep Breathe Stretch");
        challenge4.setLevel("5 minute challenge");
        challenge4.setDescription("1: Stand up relaxed. 2: Stand on your toes and reach the sky with your hands while you take a deep breath in. 3: Breathe out and let your hands fall to the ground and shake out your body. 4: Repeat 10 times");
        ...
        challenge11.setName("Game Of Fours");
        challenge11.setLevel("15 minute challenge");
        challenge11.setDescription("1: Notice four things in your day-to-day life that you usually wouldn't. 2: Repeat this challenge in 4 different rooms/suroundings.");
        challenge11.setValue(20);
        challengeInformationRepository.save(challenge11);
        Challenge challenge12 = new Challenge();
        challenge12.setName("Gratitude");
        challenge12.setLevel("15 minute challenge");
        challenge12.setDescription("1: Write down 10 things you are grateful for. 2: Repeat the list in your head, close your eyes and only think about the 10 things you wrote down. 3: Hold that thought for 5-10 minutes.");
        challenge12.setValue(20);
        challengeInformationRepository.save(challenge12);
        Challenge challenge13 = new Challenge();
        challenge13.setName("Simply Walking");
        challenge13.setLevel("15 minute challenge");
        challenge13.setDescription("Take a break and go outside for a 15 minute walk.");
        ...
        challenge21.setName("Limit Socal Media");
        challenge21.setLevel("24 hour challenge");
        challenge21.setDescription("Every time you are about to open social media or an app on your phone, check in on yourself. Ask yourself a simple question. For example: Do i need anything? Am i doing okay? After answering your question, continue with your day.");
        challenge21.setValue(100);
        challengeInformationRepository.save(challenge21);
        Challenge challenge22 = new Challenge();
        challenge22.setName("Take The Stairs");
        challenge22.setLevel("24 hour challenge");
        challenge22.setDescription("Today, take every opportunity there is to take the stairs and leave the elevator behind.");
        challenge22.setValue(100);
        challengeInformationRepository.save(challenge22);
        Challenge challenge23 = new Challenge();
        challenge23.setName("Walking Outside");
        challenge23.setLevel("24 hour challenge");
        challenge23.setDescription("Go outside for a nice long walk, at least 30 minutes long.");
